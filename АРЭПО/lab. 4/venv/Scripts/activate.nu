...
let virtual-env = "C:\Users\aalex\OneDrive\Рабочий стол\7 семестр\АРЭПО\lab. 4\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\aalex\OneDrive\Рабочий стол\7 семестр\АРЭПО\lab. 4\venv\Scripts\deactivate.nu"
